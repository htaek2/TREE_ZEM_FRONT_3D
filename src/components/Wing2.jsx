...
function Wing2({railOpen, onClose, gasUsage={gasUsage}, elecUsage={elecUsage} ,waterUsage={waterUsage}, active={active}, setActive={setActive}, selectedDevice, setSelectedDevice}) {
